					...
					<div class="collapse navbar-collapse" id="mainmenu">
						<ul class="navbar-nav">
							<li class="navbar-item"> 
								<a href="index2.php" class="nav-link" role="button">Logowanie</a>
							</li>
						</ul>
					</div>
				</nav>
						...
						<div class="modal-body">
							<div id="logowanie">
								<form action="rejestracja.php" method="POST">
									...
									<input type="email" name="email" class="fadeIn third text-log" placeholder="e-mail"/>
									<input type="submit" class="fadeIn third button-log" value="Zarejestruj!"/>
								</form>
							</div>
						</div>
					</div>
